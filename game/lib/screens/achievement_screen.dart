...
/// Achievement category for Racing game UI grouping.
enum AchievementCategory {
  racing('Racing', Icons.sports_motorsports_rounded),
...
/// | `achievement_unlocked` | Achievement unlocked | achievement_id, category, points |
/// | `achievement_claimed` | Achievement reward claimed | achievement_id, points |
...
class _AchievementScreenState extends State<AchievementScreen>
  ...
  // Maps achievement IDs to display categories (Racing game specific).

  /// Maps achievement IDs to display categories.
  static const Map<String, AchievementCategory> _categoryMap = {
    'gold_1000': AchievementCategory.progression,
    'level_10': AchievementCategory.progression,
    'play_100': AchievementCategory.racing,
  };
