...
/// | `daily_quest_completed` | Quest completed | quest_id, reward_claimed |
...
class _DailyQuestScreenState extends State<DailyQuestScreen> {
  ...
  void _claimReward(DailyQuest quest) {
    ...
    // Firebase Analytics: Quest completed event
    FirebaseAnalytics.instance.logEvent(
  ...
  /// Quest status icon (check for claimed, racing flag otherwise).
